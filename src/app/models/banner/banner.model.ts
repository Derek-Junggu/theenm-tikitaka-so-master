...
export class BannerModel extends BaseModel {
    ...
    public static readonly ModelName = 'BannerModel';
    ...
    constructor(public attrs: any = null) {
        super(attrs);
        this.set('modelName', BannerModel.ModelName, false);
        this.display = this.display || Cd.YN.N;
        if (this.imageIdPc) {
            this.imagePc = new FileResource();
            this.imagePc.setResource(this.siteIdx, Cd.FileClass.banner, this.objectId, this.imageIdPc);
        }
        if (this.imageIdMobile) {
            this.imageMobile = new FileResource();
            this.imageMobile.setResource(this.siteIdx, Cd.FileClass.banner, this.objectId, this.imageIdMobile);
        }
    }
